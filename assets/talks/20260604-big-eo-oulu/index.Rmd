...
<div class="fm-flow">
<svg viewBox="-70 0 720 330" xmlns="http://www.w3.org/2000/svg">
  <defs>
  ...
  <!-- Input 1: Optical / multispectral stack -->
  <g transform="translate(40, 60)">
    ...
    <text x="28" y="62" text-anchor="middle" font-size="13" font-weight="700" fill="#0072B2">Optical</text>
    <text x="28" y="76" text-anchor="middle" font-size="11" fill="#0072B2">multispectral / hyperspectral</text>
  </g>

  <!-- Input 2: Radar (SAR) stack -->
  <g transform="translate(40, 200)">
    ...
    <text x="28" y="62" text-anchor="middle" font-size="13" font-weight="700" fill="#D55E00">Radar</text>
    <text x="28" y="76" text-anchor="middle" font-size="11" fill="#D55E00">SAR &middot; active microwave</text>
  </g>
...
<div class="rovelli-cover">
<div class="rc-series">Piccola Biblioteca &middot; 705</div>
<div class="rc-author">CARLO ROVELLI</div>
<div class="rc-title"><em>L&rsquo;ordine<br/>del tempo</em></div>
<div class="rc-publisher">adelphi</div>
</div>
<div style="margin-top: 14px; font-size: 13px; color: #555;">Carlo Rovelli, <em>L&rsquo;ordine del tempo</em><br/>Adelphi, 2017</div>
</div>
]

.pull-right[
<div style="margin-top: 2em; padding: 0 1.5em;">
<div style="font-size: 26px; font-style: italic; line-height: 1.35; color: #1A292C;">
&ldquo;L&rsquo;emozione del tempo &egrave; precisamente ci&ograve; che per noi &egrave; il tempo. <strong>Il tempo siamo noi.</strong>&rdquo;
</div>
<div style="font-size: 16px; color: #555; margin-top: 18px; line-height: 1.4;">
&ldquo;The emotion of time is precisely what time is for us. <strong>Time is us.</strong>&rdquo;
</div>
</div>
] -->
...
<div class="volumes-takeaway" style="font-size: 28px;">
Develop new methods to integrate multi-sensor satellite EO data to produce mining indicators that scale globally.
</div>
...
.pull-left.center[
<img src="./img/dog-by-Tiina-Hayha-CC-BY-SA-4-0.jpg" alt="Spotted dog among autumn leaves" height="450" />
...
.pull-right.center[
<img src="./img/carajas-mine-satellite-dog.png" alt="Carajás iron-ore mine, satellite view" height="450" />
...
<div class="volumes-takeaway" style="font-size: 24px;">
Computer vision and natural language processing architectures bring inductive biases ill-suited to spectra, time, and irregular geographies.
</div>
